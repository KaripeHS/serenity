...
CREATE TABLE IF NOT EXISTS offline_sync_queue (
  ...
  entity_type VARCHAR(100) NOT NULL, -- visit_check_in, visit_check_out, care_note, etc.
...
COMMENT ON TABLE offline_sync_queue IS 'Queue for synchronizing offline mobile app data';
