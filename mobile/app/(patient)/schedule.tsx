/**
 * Patient Schedule Screen - View upcoming and past visits
 * HIPAA Compliant - Shows only the patient's own visits
 */
...
export default function PatientScheduleScreen() {
    ...
    const loadData = async () => {
        try {
            ...
            try {
                const response = await api.get('/patient/portal/schedule');
                ...
                setVisits([
                    ...
                    { id: '4', date: '2024-12-06', time: '10:00 AM', endTime: '12:00 PM', caregiverName: 'Sarah Johnson, RN', visitType: 'Skilled Nursing', status: 'completed', notes: 'Vitals stable, medication review completed' },
                    { id: '5', date: '2024-12-04', time: '2:00 PM', endTime: '4:00 PM', caregiverName: 'Mike Davis, HHA', visitType: 'Personal Care', status: 'completed' },
                    { id: '6', date: '2024-12-02', time: '10:00 AM', endTime: '12:00 PM', caregiverName: 'Sarah Johnson, RN', visitType: 'Skilled Nursing', status: 'completed' },
                ]);
            }
        } catch (error) {
    ...
    return (
        ...
        >
            ...
            <View className="flex-row px-4 pt-4 pb-2">
                <TouchableOpacity
                    className={`flex-1 py-3 mx-1 rounded-xl ${filter === 'upcoming' ? 'bg-primary' : 'bg-white border border-gray-200'}`}
                ...
                <TouchableOpacity
                    className={`flex-1 py-3 mx-1 rounded-xl ${filter === 'past' ? 'bg-primary' : 'bg-white border border-gray-200'}`}
