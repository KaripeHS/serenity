...
function Header() {
  return (
    <header className="sticky top-0 z-[var(--z-sticky)] bg-mist-white/95 backdrop-blur-md border-b border-warm-gray-200">
        ...
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden lg:flex items-center gap-8">
            ...
            <div className="flex items-center gap-3 ml-4">
              ...
              <Link
                href="/contact"
                className="px-6 py-2.5 bg-gradient-to-r from-serenity-green-500 to-serenity-green-600 text-white font-semibold rounded-xl hover:from-serenity-green-600 hover:to-serenity-green-700 shadow-md hover:shadow-lg glow-on-hover transition-all active:scale-95"
              >
                Get Started
              </Link>
            </div>
          ...
          {/* Mobile Menu Button */}
          <button className="lg:hidden p-2 text-warm-gray-700 hover:text-serenity-green-600" aria-label="Toggle menu">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><Link href="/services" className="transition-colors" style={{ color: 'rgba(255, 255, 255, 0.75)' }}>Personal Care</Link></li>
              <li><Link href="/services" className="transition-colors" style={{ color: 'rgba(255, 255, 255, 0.75)' }}>Skilled Nursing</Link></li>
              <li><Link href="/services" className="transition-colors" style={{ color: 'rgba(255, 255, 255, 0.75)' }}>Companionship</Link></li>
              <li><Link href="/services" className="transition-colors" style={{ color: 'rgba(255, 255, 255, 0.75)' }}>Respite Care</Link></li>
              <li><Link href="/services" className="transition-colors" style={{ color: 'rgba(255, 255, 255, 0.75)' }}>Pod-Based Care</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><Link href="/about" className="transition-colors" style={{ color: 'rgba(255, 255, 255, 0.75)' }}>About Us</Link></li>
              <li><Link href="/careers" className="transition-colors" style={{ color: 'rgba(255, 255, 255, 0.75)' }}>Careers</Link></li>
              <li><Link href="/contact" className="transition-colors" style={{ color: 'rgba(255, 255, 255, 0.75)' }}>Contact</Link></li>
              <li><Link href="/about#team" className="transition-colors" style={{ color: 'rgba(255, 255, 255, 0.75)' }}>Our Team</Link></li>
              <li><Link href="/about#mission" className="transition-colors" style={{ color: 'rgba(255, 255, 255, 0.75)' }}>Mission & Values</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3" style={{ color: 'rgba(255, 255, 255, 0.85)' }}>
              <li className="flex items-center gap-2">
                ...
                <a href="tel:+15134005113" className="transition-colors">(513) 400-5113</a>
              </li>
              <li className="flex items-center gap-2">
                <svg className="w-5 h-5" style={{ color: 'rgba(255, 255, 255, 0.6)' }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <a href="mailto:Hello@serenitycarepartners.com" className="transition-colors">Hello@serenitycarepartners.com</a>
              </li>
        ...
        <div className="pt-8 mt-8" style={{ borderTop: '1px solid rgba(255, 255, 255, 0.15)' }}>
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex gap-6 text-sm">
              <Link href="/privacy" className="transition-colors" style={{ color: 'rgba(255, 255, 255, 0.7)' }}>Privacy Policy</Link>
              <Link href="/terms" className="transition-colors" style={{ color: 'rgba(255, 255, 255, 0.7)' }}>Terms of Service</Link>
              <Link href="/hipaa" className="transition-colors" style={{ color: 'rgba(255, 255, 255, 0.7)' }}>HIPAA Compliance</Link>
            </div>
          </div>
        </div>
      </div>
...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body className={`${dmSerif.variable} ${inter.variable} ${manrope.variable}`}>
