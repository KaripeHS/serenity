        ...
        <div className="relative container mx-auto px-6 py-20 lg:py-32">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative lg:h-[600px] fade-in" style={{ animationDelay: '200ms' }}>
              ...
              <div className="absolute inset-0 bg-gradient-to-br from-green-100 to-blue-100 rounded-3xl shadow-2xl hover-lift">
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="text-center p-8">
                    <svg className="w-32 h-32 mx-auto text-green-600 opacity-50" fill="none" stroke="currentColor" viewBox="0 0 24 24">
