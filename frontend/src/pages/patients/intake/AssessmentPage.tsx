...
import { AssessmentForm } from '../../../components/patients/intake/AssessmentForm';
...
export function AssessmentPage() {
  ...
  const handleSave = (data: any, completedFields: string[]) => {
    ...
    const stepIndex = parsed.steps?.findIndex((s: any) => s.id === 'assessment') ?? -1;
    const stepData = {
      id: 'assessment',
      status,
      progress,
