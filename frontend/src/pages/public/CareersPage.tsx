/**
 * Careers Page
 * Job listings and application form with ERP integration.
 * Faithfully ported from public-site/app/careers/page.tsx preserving all design details.
 * Forms submit to /api/public/careers/apply to feed into the ERP talent pipeline.
 */
...
export default function CareersPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Prepare form data for submission to ERP talent pipeline
      const payload = {
        name: formData.name,
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* Embedded Application Form - Integrates with ERP */}
      {showForm && (
        <section id="application-form" className="py-24 bg-white scroll-mt-20">
          <div className="container mx-auto px-8 max-w-4xl">
            <div className="text-center mb-8">
              <h2
                className="mb-4 text-warm-gray-900 font-serif"
                style={{
                  fontSize: 'clamp(32px, 4vw, 44px)',
                  lineHeight: '1.2',
                  letterSpacing: '-0.01em',
      ...
      <section className="py-24 bg-serenity-green-500 text-white">
        <div className="container mx-auto px-8 text-center">
          <h2
            className="mb-4 text-white font-serif"
            style={{
