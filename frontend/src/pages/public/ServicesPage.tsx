          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative h-[500px] lg:h-[600px] fade-in" style={{ animationDelay: '200ms' }}>
              <div className="absolute inset-0 rounded-xl hover-lift overflow-hidden shadow-xl">
                <img
                  src="https://images.unsplash.com/photo-1611095966444-9008c3e1d1a6?q=80&w=1200&auto=format&fit=crop"
                  alt="Compassionate caregiver preparing a meal with senior in a warm home kitchen"
          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid md:grid-cols-3 gap-6">
              ...
              <div className="rounded-2xl overflow-hidden shadow-lg hover-lift h-80 fade-in" style={{ animationDelay: '100ms' }}>
                <img
                  src="https://images.unsplash.com/photo-1610819430149-2c70d09811e2?q=80&w=800&auto=format&fit=crop"
                  alt="Caregiver gently assisting senior with mobility and walking"
                  className="w-full h-full object-cover"
                />
              </div>
